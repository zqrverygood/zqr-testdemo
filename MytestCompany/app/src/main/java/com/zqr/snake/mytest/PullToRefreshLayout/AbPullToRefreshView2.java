 ...
 */
public class AbPullToRefreshView2 extends LinearLayout {
	 ...
	 */
	public AbPullToRefreshView2(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	 ...
	 * @param context the context
	 */
	public AbPullToRefreshView2(Context context) {
		super(context);
		init(context);
	}
	...
	public interface OnFooterLoadListener {
		 ...
		 * @param view the view
		 */
		public void onFooterLoad(AbPullToRefreshView2 view);
	}
	...
	public interface OnHeaderRefreshListener {
		 ...
		 * @param view the view
		 */
		public void onHeaderRefresh(AbPullToRefreshView2 view);
	}
