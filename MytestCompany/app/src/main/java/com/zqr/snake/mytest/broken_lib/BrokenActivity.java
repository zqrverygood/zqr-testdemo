package com.zqr.snake.mytest.broken_lib;
...
public class BrokenActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        myView = (ImageView) findViewById(R.id.demo_myview);
        button = (Button) findViewById(R.id.demo_button);

        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(BrokenActivity.this, "Button onClick", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void refreshDate() {
        ...
        listView.setAdapter(new SampleAdapter(BrokenActivity.this, android.R.layout.simple_list_item_1, items));
