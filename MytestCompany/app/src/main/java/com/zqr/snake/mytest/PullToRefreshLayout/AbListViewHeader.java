 ...
 */
package com.zqr.snake.mytest.PullToRefreshLayout;
...
public class AbListViewHeader extends LinearLayout {
	...
	private LayoutParams layoutParamsWW;
	 ...
	 * ProgressBar大小
	 */
	private float  PROGRESSBAR_SIZE=45;
...
//		 InputStream is = r.openRawResource(R.drawable.pulltorefresh_head_icon);
//		BitmapDrawable  bmpDraw = new BitmapDrawable(is);
//		arrowImage = bmpDraw.getBitmap();
...
//		arrowImageView.setImageBitmap(arrowImage);
		...
		headerProgressBar.setIndeterminateDrawable(mContext.getResources().getDrawable(R.drawable.refresh_anim));
//		headerProgressBar.setVisibility(View.GONE);

		layoutParamsWW = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
		layoutParamsWW.gravity = Gravity.CENTER;
		layoutParamsWW.width = AbViewUtil.scaleValue(mContext, PROGRESSBAR_SIZE);
		layoutParamsWW.height = AbViewUtil.scaleValue(mContext, PROGRESSBAR_SIZE);
...
*/
			...
			case STATE_READY:
				isRefresh=false;
				//1268  部分机子要用此方法才可以显示 OPPP R1C
				Drawable d = this.getResources().getDrawable(R.drawable.refresh_01);
				d.setBounds(0,0,AbViewUtil.scaleValue(mContext, PROGRESSBAR_SIZE),AbViewUtil.scaleValue(mContext, PROGRESSBAR_SIZE));
				headerProgressBar.setIndeterminateDrawable(d);
//				headerProgressBar.setIndeterminateDrawable(mContext.getResources().getDrawable(R.drawable.refresh));
				headerProgressBar.setProgressDrawable(mContext.getResources().getDrawable(R.drawable.refresh_01));
				if (mState != STATE_READY) {
//					arrowImageView.clearAnimation();
...
//					lastRefreshTime = AbDateUtil.getCurrentDate(AbDateUtil.dateFormatHMS);
			...
			case STATE_REFRESHING:
				isRefresh=false;
				headImage.removeView(headerProgressBar);
				headerProgressBar=null;
				headerProgressBar = new ProgressBar(getContext(),null,android.R.attr.progressBarStyle);
				headerProgressBar.setIndeterminateDrawable(mContext.getResources().getDrawable(R.drawable.refresh_anim));

				headImage.addView(headerProgressBar, layoutParamsWW);
				/*headerProgressBar.setIndeterminateDrawable(getResources().getDrawable(
						R.drawable.refresh_anim));*/
//				headerProgressBar.setIndeterminateDrawable(mContext.getResources().getDrawable(R.drawable.refresh_anim));
