...
/**
 * 博客地址：  http://blog.csdn.net/zxt0601/article/details/52420706
 */
...
public class RecyclerViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRv.addItemDecoration(new DividerItemDecoration(RecyclerViewActivity.this, DividerItemDecoration.VERTICAL_LIST));
