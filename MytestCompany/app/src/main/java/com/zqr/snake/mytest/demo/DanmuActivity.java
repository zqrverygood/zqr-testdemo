...
public class DanmuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_danmu);
        final VideoView videoView = (VideoView) findViewById(R.id.video_view);
        if( Environment.getDataDirectory()+"/data/666.mp4" != null){
            videoView.setVideoPath( Environment.getDataDirectory()+"/data/666.mp4");//得到手机内存路径
            videoView.start();
        }
